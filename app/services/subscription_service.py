...
PLANS = {
    ...
    "pro":   {"price_id": settings.stripe_price_id_pro or "price_1TiRAF2MK0YOPZban716STqe", "limit": 30},
    "max":   {"price_id": settings.stripe_price_id_max or "price_1TiRAc2MK0YOPZba3y9ftJvw", "limit": None},
}
